            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <form method="POST" action="{{ route('pedidos.store') }}">
                            ...
                            <!-- Fecha de emision -->
                            <div>
                                <x-label for="fecha_emision" :value="__('Fecha')" />

                                <x-input id="fecha_emision" class="block mt-1 w-full" type="date" name="fecha_emision" :value="old('fecha_emision')" required autofocus />
                            </div>
                            ...
                            <!-- Tipo Articulo -->
                            <div class="mt-4">
                                <x-label for="estado_peticion_id" :value="__('Estado Peticion')" />
